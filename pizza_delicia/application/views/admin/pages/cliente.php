    ...
    <div class="mt-3 shadow-lg p-5 bg-white rounded">
      ...
      <!--div id="message" class="" role="alert" style="display: none;"></div-->
          ...
          <form action="#" id="form" class="form-horizontal">
            ...
            <div class="form-body">
              ...
              <div class="form-group">
                <label class="control-label col-md-3 font-weight-bold">Nome</label>
                <div class="col-md-12">
              ...
              <div class="form-group">
                <label class="control-label col-md-3 font-weight-bold">Telefone</label>
                <div class="col-md-4">
                  <input id="tel" name="cliente_telefone" placeholder="(88) 99999-9999" class="form-control" type="text" required>
                </div>
              </div>
              
              <div class="form-group">
                <label class="control-label col-md-3 font-weight-bold">E-mail</label>
                <div class="col-md-10">
                  <input name="cliente_email" placeholder="exemplo@email.com" class="form-control" type="email" required>
                </div>
              </div>
              
              <div class="form-group">
                <label class="control-label col-md-3 font-weight-bold">Senha</label>
                <div class="col-md-10">
